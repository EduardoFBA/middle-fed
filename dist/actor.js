...
exports.Actor = exports.actorRouter = void 0;
...
exports.Actor = Actor;
exports.actorRouter.get("/actor/", (req, res) => {
    // res.send({ dvklsn: 98345906 });
...
exports.actorRouter.get("/u/:username/outbox", (req, res) => {
    res.send({ dvklsn: req.params.username });
});
exports.actorRouter.post("/actor/", (req, res) => {
