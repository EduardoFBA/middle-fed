...
const activityApi_1 = require("./controller/api/activityApi");
const searchApi_1 = require("./controller/api/searchApi");
...
exports.apiRoutes.use(activityApi_1.activityApiRouter);
exports.apiRoutes.use(searchApi_1.searchApiRouter);
